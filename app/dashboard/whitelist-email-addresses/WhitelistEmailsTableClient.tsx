...
import { updateWhitelistEmail, deleteWhitelistEmail } from "./actions";
...
export default function WhitelistEmailsTableClient({ rows }: { rows: Row[] }) {
            ...
            <div style={styles.tableWrap}>
                <table style={styles.table}>
                    ...
                    <tr>
                        ...
                        <th style={styles.th}>email_address</th>
                            ...
                            <tr key={r.id}>
                                ...
                                <td style={styles.td}>
                                    {isEditing ? (
                                        <input
                                            name="email_address"
                                            form={`wea-update-${r.id}`}
                                            defaultValue={r.email_address}
                                            style={styles.inputMed}
                                            placeholder="user@example.com"
                                        />
                                    ) : (
                                        <div style={styles.cellWrap} title={r.email_address}>
                                            {r.email_address}
                                        </div>
                                    )}
                                </td>
                                ...
                                <td style={styles.td}>
                                    <div style={styles.actions}>
                                        <form id={`wea-update-${r.id}`} action={updateWhitelistEmail}>
                                            <input type="hidden" name="id" value={r.id} />
                                        </form>

                                        {isEditing ? (
                                            <>
                                                <button type="submit" form={`wea-update-${r.id}`} style={styles.btnPrimarySmall}>
                                                    Save
                                                </button>
